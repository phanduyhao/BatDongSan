				...
				<div class="container">
					<div class="row">
						<div class="col-lg-12 col-md-12">
							...
							<h2 class="ipt-title">Đăng nhập</h2>
							<span class="ipn-subtitle">Đăng nhập ngay!</span>
				...
				<div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group mb-3">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <!-- Link "Quên mật khẩu?" -->
                                <div>
                                    <a href="{{ route('showForgotPass') }}" class="link fw-medium">Quên mật khẩu?</a>	
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary full-width fw-medium">
                            Đăng nhập <i class="fa-solid fa-arrow-right-long ms-2"></i>
                        </button>
                    </div>
                </form>
                
                <div>
                  <a href="{{ route('showRegister') }}" class="link fw-medium">Chưa có tài khoản? Đăng ký tại đây</a>	
                </div>
								</div>
