				...
				<div class="container">
					<div class="row">
						<div class="col-lg-12 col-md-12">
							...
							<h2 class="ipt-title">Đăng ký tài khoản</h2>
							<span class="ipn-subtitle">Đăng ký ngay!</span>
							...
							<div class="card border-0 rounded-4 p-xl-4 p-lg-4 p-md-4 p-3">
								...
								<div class="simple-form">
									<div class="form-header text-center mb-5">
										...
										<h4 class="fs-2">Đăng ký tài khoản</h4>
									</div>
                  <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group mb-3">
                                ...
                                <input type="tel" name="phone" class="form-control" placeholder="123 456 7890" value="{{ old('phone') }}">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary full-width fw-medium">
                            Đăng ký tài khoản <i class="fa-solid fa-arrow-right-long ms-2"></i>
                        </button>
                    </div>
                </form>
                
                <div>
                  <a href="{{ route('showLogin') }}" class="link fw-medium">Đã có tài khoản? Đăng nhập tại đây</a>	
                </div>
								</div>
