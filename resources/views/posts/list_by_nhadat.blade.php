                ...
                <div class="row align-items-center px-3">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 order-lg-3 order-md-2 col-sm-6 pe-0">
                        <div class="shorting-right">
                            ...
                            <form method="GET" action="{{ route('listByNhadat', ['slug' => $slugCurrent]) }}" class="shorting-by border rounded">
                                @csrf
                        ...
                        <div class="sidebar-widgets">
                            ...
                            <div class="search-inner p-0">
                                ...
                                <div class="filter-search-box">
                                    <form method="get" method="GET" action="{{ route('listByNhadat', ['slug' => $slugCurrent]) }}" class="form-group">
                                        @csrf
                                ...
                                <div class="position-relative d-flex flex-xl-row flex-column align-items-center">
                                    ...
                                    <button type="button" class="btn btn-secondary text-nowrap" onclick="window.location.href='{{ route('listByNhadat', ['slug' => $slugCurrent]) }}'">Đặt lại</button>
    ...
    <div class="modal-dialog modal-lg" style="max-width: 1024px">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('listByNhadat', ['slug' => $slugCurrent]) }}" method="GET">
                    <div class="row">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" onclick="window.location.href='{{ route('listByNhadat', ['slug' => $slugCurrent]) }}'">Đặt lại</button>
